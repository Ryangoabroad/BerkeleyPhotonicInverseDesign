function [epsGridImport,x_min,x_span,y_min,y_span,z_center,z_span] = autoImportGeometry(eps_, freq, lumerical, baseFile, velocityMon, queueName, dx)
...
epsGridImport = 1*(epsGridImport==eps_);
